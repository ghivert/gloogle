FROM --platform=x86_64 ghcr.io/gleam-lang/gleam:v1.16.0-erlang-alpine AS builder
...
FROM --platform=x86_64 ghcr.io/gleam-lang/gleam:v1.16.0-erlang-alpine AS runner

...
fn svg(size viewbox: Int, inner_html content: String) {
  let viewbox = int.to_string(viewbox)
  let viewbox = string.join(["0", "0", viewbox, viewbox], with: " ")
